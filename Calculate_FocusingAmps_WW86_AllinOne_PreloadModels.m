function [Amplist] = Calculate_FocusingAmps_WW86_AllinOne_PreloadModels(lon_src,lat_src,lon_stas,lat_stas,Period,Model)
...
% May 29 2026: This version of the code
% can now choose between different models; the GDM52 maps
...
% rottate coordinate system so that great circle is along equator
...
% As above, so below; just get the phase velocities at these coordinates.
...
% Actually take the second derivative transverse to the path.
...
% Note: This is log amplitude, right? According to WW86 and Colleen's paper. 
% So need to exponentiate!
