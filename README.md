...
The code works as described previously, but we use the first derivative instead of the second derivative, and some of the other terms in the integrand are different. The convention for the arrival angles is positive clockwise.  


Note: If you don't want to specify your own phase velocity map, just use the function Calculate_Arrival_Angle_WW86_AllinOne_ArbitraryModel.m 
